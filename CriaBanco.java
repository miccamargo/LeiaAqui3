...
public class CriaBanco extends SQLiteOpenHelper  {
    ...
    private static final String ID_LIVROS = "IDCATEOGRIALIVRO";
    ...
    private static final String IDCATEGORIALIVRO_FK = "IDCATEOGRIALIVRO";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL( "CREATE TABLE " + getTabelaLivro() + "("
                ...
                + getIdcategorialivroFk() + "integer, foreign key(IDCATEOGRIALIVRO) references" + " TABELA_LIVROS(IDCATEOGRIALIVRO) " + ")" );
        ...
        db.execSQL( "CREATE TABLE " + getTabelaCliente() + "("
                ...
                + getIdcategorialeitorFk() + "integer, foreign key(IDCATEGORIALEITORES) references" + " TABELA_LEITORES(IDCATEOGRIALEITORES) " + ")" );
